...
const Footer = () => {
  return (
    <footer className="bg-black h-[350px] mt-14 flex justify-between bottom-0 w-full">
        <div className="ml-44">
            ...
            <div class="flex gap-3 pt-3 pl-10">
                <a href="www.facebook.com" target="_blank">
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" class="text-white text-2xl" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
